...
<img src="/crawlingo_demo.webp" alt="Crawlingo Self-Healing Demo" className="rounded-2xl border border-gray-150 dark:border-white/5 my-6 shadow-[0_8px_30px_rgb(0,0,0,0.12)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.3)]" />
